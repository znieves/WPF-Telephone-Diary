...
namespace WPF_TelephoneDiary {
    ...
    public partial class ContactsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactDataTable : global::System.Data.TypedTableBase<ContactRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ContactRow AddContactRow(string FirstName, string LastName, string PhoneNumber) {
...
namespace WPF_TelephoneDiary.ContactsDBDataSetTableAdapters {
    ...
    public partial class ContactTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Contact] WHERE (([Id] = @Original_Id) AND ([FirstName] = @Orig" +
                "inal_FirstName) AND ([LastName] = @Original_LastName) AND ([PhoneNumber] = @Orig" +
                "inal_PhoneNumber))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contact] ([FirstName], [LastName], [PhoneNumber]) VALUES (@Fir" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contact] SET [FirstName] = @FirstName, [LastName] = @LastName, [PhoneNumber] = @PhoneNumber WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([PhoneNumber] = @Original_PhoneNumber));
SELECT Id, FirstName, LastName, PhoneNumber FROM Contact WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WPF_TelephoneDiary.Properties.Settings.Default.ContactsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, PhoneNumber FROM dbo.Contact";
        ...
        public virtual int Fill(ContactsDBDataSet.ContactDataTable dataTable) {
        ...
        public virtual ContactsDBDataSet.ContactDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ContactsDBDataSet.ContactDataTable dataTable = new ContactsDBDataSet.ContactDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ContactsDBDataSet.ContactDataTable dataTable) {
